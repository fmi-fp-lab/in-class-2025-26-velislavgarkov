...
-- TODO:
-- announce/remind about second homework

-- TODO:
-- tail recursion (same as a while loop)
-- foldl as a "linear version" of foldr, draw on board
...
lastMaybe = foldr (\x acc -> case acc of; Nothing -> Just x; Just x' -> Just x') Nothing
