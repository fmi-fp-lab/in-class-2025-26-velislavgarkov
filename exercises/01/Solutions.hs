...
-- NOTE: Two contructors for a `Nat`, so 2*2=4 contructors for two `Nat`s:
-- - three of them being the "bases" of recursion
-- - the fourth one being the actual recursive one
